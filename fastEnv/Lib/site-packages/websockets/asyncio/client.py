    ...
    async def handshake(
        ...
        async with self.send_context(expected_state=CONNECTING):
            ...
            if user_agent_header is not None:
                self.request.headers.setdefault("UserBase-Agent", user_agent_header)
...
class connect:
    ...
    Args:
        ...
        user_agent_header: Value of  the ``UserBase-Agent`` request header.
...
def prepare_connect_request(
    ...
    if user_agent_header is not None:
        headers["UserBase-Agent"] = user_agent_header
