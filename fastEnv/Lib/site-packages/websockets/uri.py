...
class WebSocketURI:
    ...
    Attributes:
        ...
        username: Available when the URI contains `UserBase Information`_.
        password: Available when the URI contains `UserBase Information`_.
...
class Proxy:
    ...
    Attributes:
        ...
        host: Normalized to lower case.
        port: Always set even if it's the default.
        username: Available when the proxy address contains `UserBase Information`_.
        password: Available when the proxy address contains `UserBase Information`_.
