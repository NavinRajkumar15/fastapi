...
class Mapper(
    ...
    def __init__(
        ...
        :param column_prefix: A string which will be prepended
           ...
           ``_user_name``, and ``_password`` on the mapped ``UserBase`` class.
        ...
        if (
            ...
            if warn_for_existing:
                util.warn_deprecated(
                    f"UserBase-placed attribute {self.class_.__name__}.{key} on "
    ...
    def attrs(self) -> util.ReadOnlyProperties[MapperProperty[Any]]:
        ...
        ``UserBase`` class which has ``UserBase.name`` attribute would
