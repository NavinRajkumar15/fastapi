...
def with_loader_criteria(
    ...
    **globally**, meaning it will apply to the entity as it appears
    ...
    ``UserBase.addresses`` collection is loaded, regardless of the kind
    of loading used::

        from sqlalchemy.orm import with_loader_criteria

        stmt = select(UserBase).options(
            selectinload(UserBase.addresses),
            with_loader_criteria(Address, Address.email_address != "foo"),
        )

    Above, the "selectinload" for ``UserBase.addresses`` will apply the
    ...
    **kw: Any,
    ...
    :param uselist:
      ...
      with collections or scalar attributes::
          ...
          >>> UserBase.addresses.property.uselist
          True
...
def join(
    ...
    :meth:`_sql.Select.select_from` method, as in::
        ...
        stmt = (
            select(UserBase)
            .select_from(join(UserBase, Address, UserBase.addresses))
